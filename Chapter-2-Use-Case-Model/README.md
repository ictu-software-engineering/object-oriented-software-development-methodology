...
Các bạn làm tương tự cho tất cả các kịch bản use case còn lại. Khi có các kịch bản use case thì chúng ta đã sẵn sàng để sang chương tiếp theo [Chương 3 - Robustness Analysis](/Chapter-3-Robustness-Diagram/README.md)
